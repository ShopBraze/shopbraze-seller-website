...
export const DefaultProductDetails = {
  ...
  productDescription: {
    ...
    additionalText: "Embrace the charm of vintage roses and make a stunning statement with this co-ord set. Perfect for those who love to blend classic beauty with contemporary style. 🌸✨"
  },
  images: [
