  ...
  return (
    <div>
      <div className="flex gap-4 md:gap-6 items-start">
        <p className="text-base md:text-xl text-gray-700 font-semibold">{productData?.title}</p>
        <Button>
      ...
      <div className="pt-2 md:pt-4 flex items-center gap-4 md:gap-10">
        <div className="flex items-center gap-2 md:gap-4">
          <p className="text-2xl md:text-3xl font-semibold">₹1,999</p>
          <p className="text-gray-600 text-lg md:text-xl line-through">₹2350</p>
        </div>
        <div className="">
